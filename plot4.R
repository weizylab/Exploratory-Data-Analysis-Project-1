...
plot(data_time$Voltage~data_time$daytime,type="l",ylab="Voltage (volt)", xlab="")
...
plot(data_time$Global_reactive_power~data_time$daytime, type="l", ylab="Global Rective Power (kilowatts)", xlab="")
